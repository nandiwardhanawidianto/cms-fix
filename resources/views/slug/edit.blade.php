...
<div class="container py-4">
    ...
    <ul class="nav nav-tabs" id="editTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="counting-tab" data-bs-toggle="tab" data-bs-target="#counting" type="button" role="tab" aria-controls="counting" aria-selected="false">
                Countdown
            </button>
        </li>

        <li class="nav-item" role="presentation">
            <button class="nav-link" id="galeri-tab" data-bs-toggle="tab" data-bs-target="#galeri" type="button" role="tab" aria-controls="galeri" aria-selected="false">
                Galeri
            </button>
        </li>

        <li class="nav-item" role="presentation">
            <button class="nav-link" id="love_story-tab" data-bs-toggle="tab" data-bs-target="#love_story" type="button" role="tab" aria-controls="love_story" aria-selected="false">
                Love Story
            </button>
        </li>

        <li class="nav-item" role="presentation">
            <button class="nav-link" id="lovegift-tab" data-bs-toggle="tab" data-bs-target="#lovegift" type="button" role="tab" aria-controls="lovegift" aria-selected="false">
                Love Gift
            </button>
        </li>

        <li class="nav-item" role="presentation">
            <button class="nav-link" id="kirimkado-tab" data-bs-toggle="tab" data-bs-target="#kirimkado" type="button" role="tab" aria-controls="kirimkado" aria-selected="false">
                Kirim Kado
            </button>
        </li>

        <li class="nav-item" role="presentation">
            <button class="nav-link" id="song_list-tab" data-bs-toggle="tab" data-bs-target="#song_list" type="button" role="tab" aria-controls="song_list" aria-selected="false">
                Song List
            </button>
        </li>

        <li class="nav-item" role="presentation">
            <button class="nav-link" id="copy_link-tab" data-bs-toggle="tab" data-bs-target="#copy_link" type="button" role="tab" aria-controls="copy_link" aria-selected="false">
                Copy Link
            </button>
        </li>
    </ul>
    ...
    <div class="tab-content mt-3" id="editTabContent">
        ...
        <div class="tab-pane fade" id="copy_link" role="tabpanel" aria-labelledby="copy_link-tab">
